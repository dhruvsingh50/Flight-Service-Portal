...
<body class="leftshift" style="top:40%;" class="bg-cyan">
  <div class="body body-s">
    <form action="CancelTicket" method="post" class="sky-form">
      <header><br>CANCEL TICKET<br></header>
      <fieldset>          
        <div class="row">
          <label class="input">
            <h3 style="blue;">Enter Reservation ID:</h3>
    	...
    	<footer>
        	<button type="submit" class="button" >CANCEL THIS TICKET</button>
    	</footer>
    </form>
    </div>
  </body>
