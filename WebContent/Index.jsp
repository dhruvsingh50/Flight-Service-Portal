...
<marquee behavior="slide" direction="right">
	...
	<div class="right" style=" width:40%; top:25%; right:5%; position:absolute;">
		<h2 ALIGN = "center">LOGIN /<a style="color:yellow;"href="register\registernewuser.html">REGISTER</a><hr></h2>
		<form action="Index">
	        <table align = "center" cellpadding="15">
	            <tr><td style="">
	        	USERID:</td><td>
	            <input type="text" name="Userid" placeholder="Userid" value="123"style="width:200px; height:20px;" required>
	            </td></tr>

	            <tr><td>
	        	PASSWORD:</td><td>
	            <input type="password" name="password"placeholder="password" value="1234" style="width:200px; height:20px;" required>
	            </td></tr>
