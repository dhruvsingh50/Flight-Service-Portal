...
<body class="leftshift" style="top:40%;" class="bg-cyan">
  <div class="body body-s">
    <form action="DeleteFlight" method="post" class="sky-form">
      <header><br>Delete Flight<br></header>
      <fieldset>          
        <div class="row">
          <label class="input">
            <h3 style="blue;">Enter Flight ID:</h3>
    	...
    	<footer>
        	<button type="submit" class="button" >DELETE THIS FLIGHT</button>
    	</footer>
    </form>
    </div>
  </body>
