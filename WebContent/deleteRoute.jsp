...
<body class="leftshift" style="top:40%;" class="bg-cyan">
  <div class="body body-s">
    <form action="DeleteRoute" method="post" class="sky-form">
      <header><br>Delete ROUTE<br></header>
      <fieldset>          
        <div class="row">
          <label class="input">
            <h3 style="blue;">Enter ROUTE ID:</h3>
    	...
    	<footer>
        	<button type="submit" class="button" >DELETE THIS ROUTE</button>
    	</footer>
    </form>
    </div>
  </body>
